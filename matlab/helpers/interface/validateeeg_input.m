...
uiwait(fig);
    ...
    function addDescriptionComponents(descriptionPanel)
        ...
        uicontrol('parent', descriptionPanel, ...
            ...
            'FontWeight', 'bold', ...
            'Units', 'normalized', ...
            'String', 'Validate EEG dataset', ...
            'HorizontalAlignment', 'Left', ...
            'Position', [0 0.8 0.4 0.2]);
        uicontrol('parent', descriptionPanel, ...
            'Style', 'Text', ...
            'Units', 'normalized', ...
            'String', ['Validates the HED tags in a EEG dataset.' ...
            ' There will be a error log file generated from the' ...
            ' validation. To generate warning and extension log' ...
            ' files uncheck ''Only generate error log''. By default' ...
            ' tags not in the HED are accepted that start with the' ...
            ' prefix of a tag that has the extension allowed attribute' ...
            ' or is a leaf tag. If you don''t want this behavior' ...
            ' uncheck ''Extensions allowed.'''], ...
            'HorizontalAlignment', 'Left', ...
