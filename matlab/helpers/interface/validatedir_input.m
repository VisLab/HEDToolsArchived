...
function [cancelled, extensionsAllowed, hedXML, inputDir, outputDir, ...
    subdirectories] = validatedir_input()
...
outputDir = pwd;
subdirectories = true;
title = 'Inputs for validating the HED tags in a directory of data files';
...
uiwait(fig);
    ...
    function addDescriptionComponents(descriptionPanel)
        ...
        uicontrol('parent', descriptionPanel, ...
            ...
            'FontWeight', 'bold', ...
            'Units', 'normalized', ...
            'String', 'Validate directory of data files', ...
            'HorizontalAlignment', 'Left', ...
            'Position', [0 0.8 0.4 0.2]);
        uicontrol('parent', descriptionPanel, ...
            'Style', 'Text', ...
            'Units', 'normalized', ...
            'String', ['Validates the HED tags in a directory of data' ...
            ' files. Please specify a' ...
            ' input directory that you want to be validated. There will be' ...
            ' a output file generated for each' ...
            ' dataset that is validated. By default the subdirectories' ...
            ' are looked in for data files to validate.'], ...
            'HorizontalAlignment', 'Left', ...
    ...
    function inputDirEditBoxCallback(src, ~)
        ...
        if exist(study, 'file')
            ...
            errordlg(['Input directory is invalid. Setting the input' ...
                ...
                'Invalid directory');
            set(src, 'String', inputDir);
        end
    end % inputDirEditBoxCallback

    function validateAllCallback(src, ~)
        subdirectories = get(src, 'Max') == get(src, 'Value');
