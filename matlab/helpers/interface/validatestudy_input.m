...
function [cancelled, extensionsAllowed, hedXML, outputDir, studyFile, ...
    validateDatasets] = validatestudy_input()
...
title = 'Inputs for validating EEG study HED tags';
...
uiwait(fig);
    ...
    function validateAllCallback(src, ~)
        validateDatasets = get(src, 'Max') == get(src, 'Value');
