...
uiwait(fig);
    ...
    function addDescriptionComponents(descriptionPanel)
        ...
        uicontrol('parent', descriptionPanel, ...
            ...
            'FontWeight', 'bold', ...
            'Units', 'normalized', ...
            'String', 'Validate EEG study', ...
            'HorizontalAlignment', 'Left', ...
            'Position', [0 0.8 0.4 0.2]);
        uicontrol('parent', descriptionPanel, ...
            'Style', 'Text', ...
            'Units', 'normalized', ...
            'String', ['Validates the HED tags in data files that are' ...
            ' associated with a EEG study. Please specify a' ...
            ' study that you want to be validated. There will be a' ...
            ' error log file generated for each study dataset that is' ...
            ' validated. The output directory will mirror the' ...
            ' directory structure containing the study data files with' ...
            ' the log files in place of the data files. To generate' ...
            ' warning and extension log files uncheck ''Only generate' ...
            ' error log''. By default tags not in the HED are accepted' ...
            ' that start with the prefix of a tag that has the' ...
            ' extension allowed attribute or is a leaf tag. If you' ...
            ' don''t want this behavior uncheck ''Extensions' ...
            ' allowed.'''], ...
            'HorizontalAlignment', 'Left', ...
            'Position', [0 0.08 1 0.8]);
