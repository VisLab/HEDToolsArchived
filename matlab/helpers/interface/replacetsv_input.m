...
createPanel(tab);
    ...
    function helpCallback(src, eventdata) %#ok<INUSD>
        ...
        helpdlg(sprintf(['Find and replace the HED tags in a tab-separated' ...
            ' file using replacement file. ' ...
            ...
            ' A two column tab-delimited file used to find and' ...
            ' replace the HED tags in the input file. with their replacement. that \n\nOutput file - The updated' ...
            ' tab-separated file containing the new replacement tags.' ...
            ' \n\nHED tag ' ...
