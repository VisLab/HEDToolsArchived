function test_suite = test_checktakevalue%#ok<STOUT>
initTestSuite;
...
[errors, tags] = checktakevalue(values.hedMaps, values.Tags2, ...
    values.Tags2);
...
fprintf(['\nIt should return no errors when there are numeric' ...
    ' tags present\n']);
[errors, tags] = checktakevalue(values.hedMaps, values.Tags3, ...
    values.Tags3);
assertTrue(isempty(errors));
assertTrue(isempty(tags));
...
fprintf(['\nIt should return errors when there are tags present ' ...
    ...
    ' wrong units\n']);
[errors, tags] = checktakevalue(values.hedMaps, values.Tags4, ...
    values.Tags4);
assertFalse(isempty(errors));
assertFalse(isempty(tags));
assertEqual(length(tags), 2);
...
[errors, tags] = checktakevalue(values.hedMaps, values.Tags5, ...
    values.Tags5);
assertTrue(isempty(errors));
assertTrue(isempty(tags));
...
[errors, errorTags, warnings, warningTags] = ...
    checktakevalue(values.hedMaps, values.Tags6, values.Tags6);
assertTrue(isempty(errors));
...
[errors, tags] = checktakevalue(values.hedMaps, values.Tags7, ...
    values.Tags7);
assertFalse(isempty(errors));
assertFalse(isempty(tags));
assertEqual(length(tags), 2);
...
[errors, tags] = checktakevalue(values.hedMaps, values.Tags8, ...
    values.Tags8);
assertTrue(isempty(errors));
assertTrue(isempty(tags));
...
fprintf(['\nIt should return errors when there are tags present in ' ...
    ...
    ' the wrong units\n']);
[errors, tags] = checktakevalue(values.hedMaps, values.Tags9, ...
    values.Tags9);
assertFalse(isempty(errors));
assertFalse(isempty(tags));
assertEqual(length(tags), 2);
...
fprintf(['\nIt should return no errors when there are numeric' ...
    ...
    ' present\n']);
[errors, tags] = checktakevalue(values.hedMaps, values.Tags10, ...
    values.Tags10);
assertTrue(isempty(errors));
assertTrue(isempty(tags));
...
[errors, errorTags, warnings, warningTags] = ...
    checktakevalue(values.hedMaps, values.Tags11, values.Tags11);
assertTrue(isempty(errors));
assertTrue(isempty(errorTags));
assertFalse(isempty(warnings));
assertFalse(isempty(warningTags));
