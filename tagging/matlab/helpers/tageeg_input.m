...
if ishandle(inputFig)
    ...
    function createWriteGroupPanel()
        ...
        uicontrol('Parent', writeButtonGroup, ...
            'Style', 'RadioButton', 'Tag', 'Double One', ...
        ...
        uicontrol('Parent', writeButtonGroup, ...
            ...
            'String', 'Single one(.set file)', 'Enable', 'off', 'Tooltip', ...
        ...
        uicontrol('Parent', writeButtonGroup, ...
            ...
            'String', 'Single two(.set and .fdt)', 'Enable', 'off', 'Tooltip', ...
        ...
        uicontrol('Parent', writeButtonGroup, ...
            ...
            'String', 'Preserve two', 'Value', 1', 'Enable', 'off', 'Tooltip', ...
