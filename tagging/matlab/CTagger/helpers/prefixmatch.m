% This function looks for a prefix tag match in a tag.
%
% Usage:
%   >>  found = prefixmatch(tags, search)
%
% Inputs:
...
function found = prefixmatch(tags, search)
parseArguments();
found = any(~cellfun(@isempty, regexpi(tags, ['^' search '/?'])));
