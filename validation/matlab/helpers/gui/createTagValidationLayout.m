...
createPanel(tab);
    ...
    function createButtons(panel)
        ...
        uicontrol('Parent', panel, ...
            'String', 'Browse', ...
            'Style', 'pushbutton', ...
            'TooltipString', ['Press to choose a tab-delimited file' ...
            ' containing study tags'], ...
            'Units','normalized',...
        ...
        uicontrol('Parent', panel, ...
            ...
            'Style', 'pushbutton', ...
            'TooltipString', ...
            ['Press to choose a tab-delimited remap file mapping' ...
            ' old HED tags to new HED tags'], ...
            'Units','normalized',...
        ...
        uicontrol('Parent', panel, ...
            ...
            'Style', 'pushbutton', ...
            'TooltipString', ...
            ['Press to choose a output directory where the validation' ...
        ...
        uicontrol('Parent', panel, ...
            ...
            'Style', 'pushbutton', ...
            'TooltipString', ...
            ['Press to validate a tab-delimited file containing study' ...
            ' tags against a XML file containing all of the HED tags'], ...
            'Units','normalized',...
    ...
    function createCheckboxes()
        ...
        uicontrol('Parent', panel, ...
            ...
            'String', 'Header', ...
            'Value', 1, ...
            'TooltipString', ['True if the tab-delimited file has a' ...
        ...
        uicontrol('Parent', panel, ...
            ...
            'Value', 1, ...
            'TooltipString', ['True if descendants of extension' ...
        ...
        uicontrol('Parent', panel, ...
            ...
            'String', 'Write Output', ...
            'Value', 0, ...
            'TooltipString', ['True if the 3 output files are to be' ...
            ' written to the output directory, false if otherwise '], ...
            'Units','normalized',...
    ...
    function createEditBoxes(panel)
        ...
        tsvFileCtrl = uicontrol('Parent', panel, ...
            ...
            'HorizontalAlignment', 'Left', ...
            'String', '', ...
            'TooltipString', ['A tab-delimited file containing study' ...
            ' tags'], ...
            'Units','normalized',...
        ...
        remapFileCtrl = uicontrol('Parent', panel, ...
            ...
            'HorizontalAlignment', 'Left', ...
            'String', '', ...
            'TooltipString', ['A tab-delimited remap file mapping' ...
            ' old HED tags to new HED tags'], ...
            'Units','normalized',...
        ...
        outputDirectoryCtrl = uicontrol('Parent', panel, ...
            ...
            'HorizontalAlignment', 'Left', ...
            'String', pwd, ...
            'TooltipString', ['A output directory where the validation' ...
            ' files are written to'], ...
            'Units','normalized',...
        ...
        uicontrol('Parent', panel, ...
            ...
            'String', '1', ...
            'TooltipString', ...
            ['Tag columns in tab-delimited file (single number or' ...
            ' comma sepearted)'], ...
            'Units','normalized',...
    ...
    function createLabels(panel)
        ...
        uicontrol('parent', panel, ...
            'Style', 'Text', ...
            'Units', 'normalized', ...
            'String', ['Validates the tags in a tab-delimited text' ...
        ...
        elseif isempty(tsvTagColumns)
            ...
            try
                [errors, warnings, extensions] = ...
                    ...
                    extensionAllowed, 'writeOutput', writeOutput);
