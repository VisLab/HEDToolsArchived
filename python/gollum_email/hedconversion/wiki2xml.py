...
'''
from hedconversion.parsewiki import hed_wiki_2_xml_tree, get_hed_change_log, prettify
import os
import tempfile
import urllib
...
def convert_hed_wiki_2_xml():
    ...
    try:
        ...
        hed_info_dictionary = {"hed_xml_tree":hed_xml_tree,"hed_change_log":hed_change_log,"hed_wiki_file_location":hed_wiki_file_location,"hed_xml_file_location":hed_xml_file_location}; 
    except:
